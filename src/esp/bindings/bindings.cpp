...
PYBIND11_MODULE(habitat_sim_bindings, m) {
  ...
  py::class_<RenderCamera, AttachedObject,
      ...
      .def(py::init<std::reference_wrapper<scene::SceneNode>, const vec3f&,
  ...
  py::class_<Sensor, AttachedObject,
  ...
  py::class_<sensor::PinholeCamera, sensor::Sensor,
